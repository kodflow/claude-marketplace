...
tools_json() {
    local result="{}"
    for tool in project-linter eslint ruff golangci-lint cargo-clippy rubocop phpstan ktlint swiftlint luacheck shellcheck hadolint clang-tidy mypy tsc prettier wrangler psql postgres; do
        local safe_name
