...
PROTECTED_PATHS_FILE="${CLAUDE_PROJECT_DIR:-.}/.claude/protected-paths.yml"
...
# === project-linter: package context before edit ===
# Calls project-linter HTTP endpoint to surface existing issues in the package
# being modified. Graceful degradation if project-linter is not running.
