...
description: 'Infrastructure automation with Terraform/Terragrunt. Dispatches to DevOps specialist
  agents for cloud-specific analysis. Use when for Terraform, OpenTofu or Terragrunt work:
  planning a change, reading a plan critically, validating, or documenting modules.'
metadata:
  short-description: Infrastructure automation with Terraform/Terragrunt
  generated-from: plugins/*/skills/infra
...
| Action | Module |
|--------|--------|
| Detection, plan, apply, docs, Terragrunt | Read `terraform.md` |
| Agent dispatch & skill integration | Read `agents.md` |
| Validation suite & safety guards | Read `validate.md` |
...
- `SUBAGENTS` → legacy specialist dispatch in `agents.md` (unchanged)
