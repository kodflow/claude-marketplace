...
"${CODEX_HOME:-$HOME/.codex}"/skills/_shared/scripts/detect-models.sh` and write the resolved id,
...
```bash
bash "${CODEX_HOME:-$HOME/.codex}"/skills/challenge/scripts/validate-goal-prompt.sh .claude/goals/<slug>.md
```
