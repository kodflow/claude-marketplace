...
CTX="$(bash "${CODEX_HOME:-$HOME/.codex}"/skills/_shared/scripts/review-context.sh "$PROJECT_DIR")"
printf '%s\n' "$CTX"
...
CANARY_ARTIFACT="$(RTK_BYPASS=1 bash "${CODEX_HOME:-$HOME/.codex}"/skills/_shared/scripts/review-canary.sh \
