...
description: Extract reusable patterns from the current session and save them to the local
  knowledge base. Use when at the end of a session that produced a reusable insight — a pattern
  worth keeping, a pitfall worth remembering, a convention the project settled on.
metadata:
  short-description: Extract reusable patterns from the current session and save them to the
    local kn
  generated-from: plugins/*/skills/learn
