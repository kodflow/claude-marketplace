...
description: Health check for this Claude Code installation. Verifies that every skill, agent,
  ...
  dimensions and prints a dashboard with the specific files at fault. Use when after upgrading
  Claude Code, after editing settings/agents/skills, when a skill or hook misbehaves, or as
  a pre-flight check at the start of a session in a fresh environment.
metadata:
  short-description: Health check for this Claude Code installation
  generated-from: plugins/*/skills/audit
